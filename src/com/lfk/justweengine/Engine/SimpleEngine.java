...
//        setScreenOrientation(ScreenMode.LANDSCAPE);
        ...
        // init surfaceView
        e_surfaceView = new SurfaceView(this.getActivity());

        // set content view
        this.getActivity().setContentView(e_surfaceView);
...
//        System.exit(RESULT_OK);
    ...
    public void setScreenOrientation(ScreenMode mode) {
        this.getActivity().setRequestedOrientation(mode.value);
    }
    ...
    public CopyOnWriteArrayList<BaseSub> getSpriteGroup()
    {
    	return e_sprite_group;
    }
    ...
    public void setPauseEngin(Boolean isPause)
    {
    	e_paused = isPause;
    }
    ...
    {
    	e_running = false;
    	e_sprite_group.clear();
    	e_sprite_recycle_group.clear();
    	e_button_group.clear();
    }
}
